...
import { Bus, Check, Eye, Filter, Plus, Search, Trash2, Wrench } from "lucide-react";
...
import { BUSES, type BusFilter, type BusRow } from "@/lib/mock/buses";
import { cn } from "@/lib/utils/cn";

import { AddBusModal } from "./add-bus-modal";
import { BusProfileModal } from "./bus-profile-modal";

const FILTERS: { key: BusFilter; labelKey: string }[] = [
    ...
    <div>
      <Card>
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <h2 className="text-base font-semibold text-brand-navy">{t("busList")}</h2>
