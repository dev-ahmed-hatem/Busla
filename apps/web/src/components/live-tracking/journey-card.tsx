...
import type { Journey } from "@/lib/mock/live-tracking";
...
export function JourneyCard({
  ...
  return (
    ...
    >
      ...
      <div className="mt-1 text-xs text-slate-400">{journey.headingLabel}</div>
      ...
      <div className="flex items-center gap-3 text-xs text-slate-500">
        ...
        <span className="inline-flex items-center gap-1">
          ...
          {journey.minutes} mins
        </span>
        <span className="inline-flex items-center gap-1">
          <MapPin className="h-3.5 w-3.5" />
          {journey.kmDone}/{journey.kmTotal} KM
        </span>
      </div>
